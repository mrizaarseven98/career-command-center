...
The workflow may use information that you choose to place in your Career Command Center workspace, including:
...
Your files remain in the workspace until you remove them. The app can archive or delete opportunity records. Permanent deletion keeps only a minimal deduplication marker so the same posting is not suggested again. Generated application files are not deleted automatically.

Uninstalling the plugin or app does not delete your chosen workspace. You control that folder through macOS and may remove it separately.

## Security

No software can guarantee absolute security. Keep sensitive career documents in a location with appropriate macOS account and disk protections. Review generated material before sharing it with an employer.

## Changes

Material changes to this policy will be documented in the repository and reflected by a new effective date.

## Contact

Questions and privacy requests can be filed through the public support page:
